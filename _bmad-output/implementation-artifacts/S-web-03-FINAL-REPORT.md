...
```typescript
import type {BuildingInformationResponseDTO} from '@host-elite/contracts';
...
- No `any` types used
- Contract-based DTOs from `@host-elite/contracts`
...
| `@host-elite/contracts` | Type definitions        | workspace |
...
- ✅ `@host-elite/contracts` - BuildingInformationResponseDTO type exists
